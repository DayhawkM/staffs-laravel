<x-app-layout>
    ...
    <div class="py-12" style="background-color: #fff3f8;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" style="background-color: #ffc0cb; border-radius: 8px;">
                    <form id="orderForm">
                        <!-- Pizza Selection -->
                        <div>
                        ...
                        <!-- Add to Order Button -->
                        <button type="button" onclick="addToOrder()" style="background-color: #f48fb1; color: white; padding: 8px 16px; border-radius: 20px;">Add to Order</button>
...
function resetForm() {
    ...
    updatePriceAndToppings();  // Reset to default state
}

document.addEventListener('DOMContentLoaded', function() {
    updatePriceAndToppings();  // Initial setup when page loads
});
</script>
